...
// ensure these images is just staticly when we use the API Using he django and once we took the images path fromth json serialization from the django database model so we will not need to these one paths in here :
class TImages {
  // -- app logos
  ...
  static const String clothIcon =
      "assets/icons/categories/icons8-clothes-50.png";
  ...
  static const String furnitureIcon =
      "assets/icons/categories/icons8-dining-chair-side-vew-64.png";
  static const String jewelryIcon =
      "assets/icons/categories/icons8-sparkling-diamond-50.png";
  static const String smartphoneIcon =
